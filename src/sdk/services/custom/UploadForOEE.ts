...
/**
 * Api services for the `UploadForOEE` model.
 */
@Injectable()
export class UploadForOEEApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `UploadForOEE` object.)
   * </em>
   */
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForOEEs/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public upload(container: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForOEEs/:container/upload";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForOEEs/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };

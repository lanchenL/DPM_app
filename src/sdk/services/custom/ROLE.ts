...
export class ROLEApi extends BaseLoopBackApi {
   ...
   *  - `data` – `{boolean}` - 
   */
  public isRole(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Roles/isRole";
    let _routeParams: any = {};
   ...
   *  - `data` – `{object}` - 
   */
  public addDepartment(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Roles/addDepartment";
    let _routeParams: any = {};
   ...
   *  - `data` – `{boolean}` - 
   */
  public removeDepartment(data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Roles/removeDepartment";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);

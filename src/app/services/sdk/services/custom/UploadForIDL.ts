...
/**
 * Api services for the `UploadForIDL` model.
 */
@Injectable()
export class UploadForIDLApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `UploadForIDL` object.)
   * </em>
   */
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForIDLs/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public upload(container: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForIDLs/:container/upload";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UploadForIDLs/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
